...
COREV_PROGS=" riscv_arithmetic_basic_test_0 corev_arithmetic_base_test_0 corev_arithmetic_base_test_1 corev_rand_instr_test_0 corev_rand_instr_test_1 corev_jump_stress_test_0 corev_jump_stress_test_1 corev_rand_interrupt_0 corev_rand_interrupt_1 corev_rand_interrupt_2"
COREV_DSIM_ONLY_PROGS="corev_rand_interrupt_wfi_0 corev_rand_interrupt_wfi_1 corev_rand_interrupt_wfi_2"
